 ...
 *
 * The PDF renderer remains unchanged. This use case intentionally preserves
 * the existing PDF-generation contract while finance calculation stays in
 * the authoritative FinanceCalculationEngine.
 */
