...
private fun HeroEarningsCard(net: Double, gross: Double, otEarnings: Double, otTrend: Double) {
    ...
    Card(
        ...
        Box(
            modifier = Modifier
                .fillMaxWidth()
                .background(Brush.linearGradient(listOf(Navy, Indigo, Violet)), RoundedCornerShape(28.dp))
                .padding(20.dp)
        ) {
            Column {
                Row(
...
private fun StackedHourBar(dutyFraction: Float, otFraction: Float, phFraction: Float) {
    ...
    Canvas(modifier = Modifier.fillMaxWidth().height(22.dp).clip(RoundedCornerShape(12.dp))) {
        val width = size.width
        drawRoundRect(color = Color(0xFFEFF2F7), cornerRadius = CornerRadius(14f, 14f))
        var start = 0f
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(18.dp)) {
            Row(
                ...
                Icon(Icons.Default.ChevronRight, contentDescription = "Expand", tint = Slate400, modifier = Modifier.size(20.dp))
            }
        ...
        Column(modifier = Modifier.padding(17.dp)) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                Surface(shape = CircleShape, color = Color(0xFFFEF3C7)) {
                    Icon(Icons.Default.Payments, contentDescription = null, tint = Orange, modifier = Modifier.padding(8.dp).size(18.dp))
                }
...
private fun RecordLine(label: String, value: String, emphasized: Boolean = false) {
    Row(
        ...
        Text(
            ...
            color = if (emphasized) Teal else Slate900,
            fontWeight = FontWeight.ExtraBold
        )
    }
}
